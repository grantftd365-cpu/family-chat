...
async def init_db():
    ...
    await db.executescript("""
        ...
        CREATE TABLE IF NOT EXISTS friendships (
            ...
            status TEXT DEFAULT 'accepted',  -- accepted / pending / blocked
            created_at REAL NOT NULL,
        ...
        CREATE INDEX IF NOT EXISTS idx_readreceipt_msg ON read_receipts(message_id);
        
        -- ==================== 会话表（私聊/群聊统一） ====================
        CREATE TABLE IF NOT EXISTS conversations (
            id TEXT PRIMARY KEY,
            conv_type TEXT DEFAULT 'group',  -- group / private
            name TEXT DEFAULT '',
            avatar TEXT DEFAULT '',
        ...
        CREATE INDEX IF NOT EXISTS idx_convmem_user ON conv_members(user_id);
